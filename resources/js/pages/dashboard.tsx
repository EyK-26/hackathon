...
const Dashboard: React.FC = () => {
    ...
    const [timePeriod_2, setTimePeriod_2] = useState('');
    const [generatedMenu, setGeneratedMenu] = useState<MenuResponse | null>(null);
    const [isGenerating, setIsGenerating] = useState(false);
    const [isGenerating_2, setIsGenerating_2] = useState(false);
                            ...
                            <div className="flex justify-between items-center mb-4 relative">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <select
                                        value={timePeriod_2}
                                        onChange={async (e) => {
                                            setTimePeriod_2(e.target.value);
                                            if (e.target.value) {
                                                try {
                                                    setIsGenerating_2(true);
